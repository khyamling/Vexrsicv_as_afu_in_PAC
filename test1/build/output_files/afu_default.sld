<sld_project_info>
  <sld_infos>
    ...
    <sld_info hpath="fpga_top|inst_green_bs|ofs_plat_afu|afu|mmio_bram|vexriscvaxi4_0" library="bram_VexRiscvAxi4_0" name="vexriscvaxi4_0">
      <assignment_values>
        <assignment_value text="QSYS_NAME bram_VexRiscvAxi4_0 HAS_SOPCINFO 1 GENERATION_ID 0"/>
      </assignment_values>
    </sld_info>
    <sld_info hpath="fpga_top|inst_green_bs|ofs_plat_afu|afu|mmio_bram|clock_in" library="bram_clock_in" name="clock_in">
      <assignment_values>
        <assignment_value text="QSYS_NAME bram_clock_in HAS_SOPCINFO 1 GENERATION_ID 0"/>
      </assignment_values>
    </sld_info>
    <sld_info hpath="fpga_top|inst_green_bs|ofs_plat_afu|afu|mmio_bram|master_0" library="bram_master_0" name="master_0">
      <assignment_values>
        <assignment_value text="QSYS_NAME bram_master_0 HAS_SOPCINFO 1 GENERATION_ID 0"/>
      </assignment_values>
    </sld_info>
    <sld_info hpath="fpga_top|inst_green_bs|ofs_plat_afu|afu|mmio_bram|onchip_memory" library="bram_onchip_memory2_0" name="onchip_memory">
      <assignment_values>
        <assignment_value text="QSYS_NAME bram_onchip_memory2_0 HAS_SOPCINFO 1 GENERATION_ID 0"/>
      </assignment_values>
    </sld_info>
    <sld_info hpath="fpga_top|inst_green_bs|ofs_plat_afu|afu|mmio_bram|reset_in" library="bram_reset_in" name="reset_in">
      <assignment_values>
        <assignment_value text="QSYS_NAME bram_reset_in HAS_SOPCINFO 1 GENERATION_ID 0"/>
      </assignment_values>
    </sld_info>
  </sld_infos>
</sld_project_info>
