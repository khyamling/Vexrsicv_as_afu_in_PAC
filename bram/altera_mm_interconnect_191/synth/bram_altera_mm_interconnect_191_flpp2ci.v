// bram_altera_mm_interconnect_191_flpp2ci.v
...
`timescale 1 ps / 1 ps
module bram_altera_mm_interconnect_191_flpp2ci (
		...
		output wire [9:0]  onchip_memory1_s1_address,                        //                          onchip_memory1_s1.address
		output wire        onchip_memory1_s1_write,                          //                                           .write
		input  wire [31:0] onchip_memory1_s1_readdata,                       //                                           .readdata
		output wire [31:0] onchip_memory1_s1_writedata,                      //                                           .writedata
		output wire [3:0]  onchip_memory1_s1_byteenable,                     //                                           .byteenable
		output wire        onchip_memory1_s1_chipselect,                     //                                           .chipselect
		output wire        onchip_memory1_s1_clken,                          //                                           .clken
	...
	wire   [31:0] onchip_memory1_s1_agent_m0_readdata;                   // onchip_memory1_s1_translator:uav_readdata -> onchip_memory1_s1_agent:m0_readdata
	wire          onchip_memory1_s1_agent_m0_waitrequest;                // onchip_memory1_s1_translator:uav_waitrequest -> onchip_memory1_s1_agent:m0_waitrequest
	wire          onchip_memory1_s1_agent_m0_debugaccess;                // onchip_memory1_s1_agent:m0_debugaccess -> onchip_memory1_s1_translator:uav_debugaccess
	wire   [31:0] onchip_memory1_s1_agent_m0_address;                    // onchip_memory1_s1_agent:m0_address -> onchip_memory1_s1_translator:uav_address
	wire    [3:0] onchip_memory1_s1_agent_m0_byteenable;                 // onchip_memory1_s1_agent:m0_byteenable -> onchip_memory1_s1_translator:uav_byteenable
	wire          onchip_memory1_s1_agent_m0_read;                       // onchip_memory1_s1_agent:m0_read -> onchip_memory1_s1_translator:uav_read
	wire          onchip_memory1_s1_agent_m0_readdatavalid;              // onchip_memory1_s1_translator:uav_readdatavalid -> onchip_memory1_s1_agent:m0_readdatavalid
	wire          onchip_memory1_s1_agent_m0_lock;                       // onchip_memory1_s1_agent:m0_lock -> onchip_memory1_s1_translator:uav_lock
	wire   [31:0] onchip_memory1_s1_agent_m0_writedata;                  // onchip_memory1_s1_agent:m0_writedata -> onchip_memory1_s1_translator:uav_writedata
	wire          onchip_memory1_s1_agent_m0_write;                      // onchip_memory1_s1_agent:m0_write -> onchip_memory1_s1_translator:uav_write
	wire    [2:0] onchip_memory1_s1_agent_m0_burstcount;                 // onchip_memory1_s1_agent:m0_burstcount -> onchip_memory1_s1_translator:uav_burstcount
	wire          onchip_memory1_s1_agent_rf_source_valid;               // onchip_memory1_s1_agent:rf_source_valid -> onchip_memory1_s1_agent_rsp_fifo:in_valid
	wire  [128:0] onchip_memory1_s1_agent_rf_source_data;                // onchip_memory1_s1_agent:rf_source_data -> onchip_memory1_s1_agent_rsp_fifo:in_data
	wire          onchip_memory1_s1_agent_rf_source_ready;               // onchip_memory1_s1_agent_rsp_fifo:in_ready -> onchip_memory1_s1_agent:rf_source_ready
	wire          onchip_memory1_s1_agent_rf_source_startofpacket;       // onchip_memory1_s1_agent:rf_source_startofpacket -> onchip_memory1_s1_agent_rsp_fifo:in_startofpacket
	wire          onchip_memory1_s1_agent_rf_source_endofpacket;         // onchip_memory1_s1_agent:rf_source_endofpacket -> onchip_memory1_s1_agent_rsp_fifo:in_endofpacket
	wire          onchip_memory1_s1_agent_rsp_fifo_out_valid;            // onchip_memory1_s1_agent_rsp_fifo:out_valid -> onchip_memory1_s1_agent:rf_sink_valid
	wire  [128:0] onchip_memory1_s1_agent_rsp_fifo_out_data;             // onchip_memory1_s1_agent_rsp_fifo:out_data -> onchip_memory1_s1_agent:rf_sink_data
	wire          onchip_memory1_s1_agent_rsp_fifo_out_ready;            // onchip_memory1_s1_agent:rf_sink_ready -> onchip_memory1_s1_agent_rsp_fifo:out_ready
	wire          onchip_memory1_s1_agent_rsp_fifo_out_startofpacket;    // onchip_memory1_s1_agent_rsp_fifo:out_startofpacket -> onchip_memory1_s1_agent:rf_sink_startofpacket
	wire          onchip_memory1_s1_agent_rsp_fifo_out_endofpacket;      // onchip_memory1_s1_agent_rsp_fifo:out_endofpacket -> onchip_memory1_s1_agent:rf_sink_endofpacket
	wire          onchip_memory1_s1_agent_rdata_fifo_src_valid;          // onchip_memory1_s1_agent:rdata_fifo_src_valid -> onchip_memory1_s1_agent_rdata_fifo:in_valid
	wire   [33:0] onchip_memory1_s1_agent_rdata_fifo_src_data;           // onchip_memory1_s1_agent:rdata_fifo_src_data -> onchip_memory1_s1_agent_rdata_fifo:in_data
	wire          onchip_memory1_s1_agent_rdata_fifo_src_ready;          // onchip_memory1_s1_agent_rdata_fifo:in_ready -> onchip_memory1_s1_agent:rdata_fifo_src_ready
	wire          onchip_memory1_s1_agent_rdata_fifo_out_valid;          // onchip_memory1_s1_agent_rdata_fifo:out_valid -> onchip_memory1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] onchip_memory1_s1_agent_rdata_fifo_out_data;           // onchip_memory1_s1_agent_rdata_fifo:out_data -> onchip_memory1_s1_agent:rdata_fifo_sink_data
	wire          onchip_memory1_s1_agent_rdata_fifo_out_ready;          // onchip_memory1_s1_agent:rdata_fifo_sink_ready -> onchip_memory1_s1_agent_rdata_fifo:out_ready
	...
	wire          onchip_memory1_s1_agent_rp_valid;                      // onchip_memory1_s1_agent:rp_valid -> router_004:sink_valid
	wire  [127:0] onchip_memory1_s1_agent_rp_data;                       // onchip_memory1_s1_agent:rp_data -> router_004:sink_data
	wire          onchip_memory1_s1_agent_rp_ready;                      // router_004:sink_ready -> onchip_memory1_s1_agent:rp_ready
	wire          onchip_memory1_s1_agent_rp_startofpacket;              // onchip_memory1_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          onchip_memory1_s1_agent_rp_endofpacket;                // onchip_memory1_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                     // cmd_mux:src_valid -> onchip_memory1_s1_burst_adapter:sink0_valid
	wire  [127:0] cmd_mux_src_data;                                      // cmd_mux:src_data -> onchip_memory1_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                     // onchip_memory1_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                   // cmd_mux:src_channel -> onchip_memory1_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                             // cmd_mux:src_startofpacket -> onchip_memory1_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                               // cmd_mux:src_endofpacket -> onchip_memory1_s1_burst_adapter:sink0_endofpacket
	wire          onchip_memory1_s1_burst_adapter_source0_valid;         // onchip_memory1_s1_burst_adapter:source0_valid -> onchip_memory1_s1_agent:cp_valid
	wire  [127:0] onchip_memory1_s1_burst_adapter_source0_data;          // onchip_memory1_s1_burst_adapter:source0_data -> onchip_memory1_s1_agent:cp_data
	wire          onchip_memory1_s1_burst_adapter_source0_ready;         // onchip_memory1_s1_agent:cp_ready -> onchip_memory1_s1_burst_adapter:source0_ready
	wire    [3:0] onchip_memory1_s1_burst_adapter_source0_channel;       // onchip_memory1_s1_burst_adapter:source0_channel -> onchip_memory1_s1_agent:cp_channel
	wire          onchip_memory1_s1_burst_adapter_source0_startofpacket; // onchip_memory1_s1_burst_adapter:source0_startofpacket -> onchip_memory1_s1_agent:cp_startofpacket
	wire          onchip_memory1_s1_burst_adapter_source0_endofpacket;   // onchip_memory1_s1_burst_adapter:source0_endofpacket -> onchip_memory1_s1_agent:cp_endofpacket
	...
	bram_altera_merlin_slave_translator_191_x56fcki #(
		...
		.uav_address            (onchip_memory1_s1_agent_m0_address),               //   input,  width = 32, avalon_universal_slave_0.address
		.uav_burstcount         (onchip_memory1_s1_agent_m0_burstcount),            //   input,   width = 3,                         .burstcount
		.uav_read               (onchip_memory1_s1_agent_m0_read),                  //   input,   width = 1,                         .read
		.uav_write              (onchip_memory1_s1_agent_m0_write),                 //   input,   width = 1,                         .write
		.uav_waitrequest        (onchip_memory1_s1_agent_m0_waitrequest),           //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (onchip_memory1_s1_agent_m0_readdatavalid),         //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (onchip_memory1_s1_agent_m0_byteenable),            //   input,   width = 4,                         .byteenable
		.uav_readdata           (onchip_memory1_s1_agent_m0_readdata),              //  output,  width = 32,                         .readdata
		.uav_writedata          (onchip_memory1_s1_agent_m0_writedata),             //   input,  width = 32,                         .writedata
		.uav_lock               (onchip_memory1_s1_agent_m0_lock),                  //   input,   width = 1,                         .lock
		.uav_debugaccess        (onchip_memory1_s1_agent_m0_debugaccess),           //   input,   width = 1,                         .debugaccess
		.av_address             (onchip_memory1_s1_address),                        //  output,  width = 10,      avalon_anti_slave_0.address
		.av_write               (onchip_memory1_s1_write),                          //  output,   width = 1,                         .write
		.av_readdata            (onchip_memory1_s1_readdata),                       //   input,  width = 32,                         .readdata
		.av_writedata           (onchip_memory1_s1_writedata),                      //  output,  width = 32,                         .writedata
		.av_byteenable          (onchip_memory1_s1_byteenable),                     //  output,   width = 4,                         .byteenable
		.av_chipselect          (onchip_memory1_s1_chipselect),                     //  output,   width = 1,                         .chipselect
		.av_clken               (onchip_memory1_s1_clken),                          //  output,   width = 1,                         .clken
		.av_read                (),                                                 // (terminated),                                       
	...
	bram_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.ECC_ENABLE                (0),
		.SYNC_RESET                (0)
	) onchip_memory1_s1_agent (
		.clk                     (clock_in_out_clk_clk),                                  //   input,    width = 1,             clk.clk
		.reset                   (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset),      //   input,    width = 1,       clk_reset.reset
		.m0_address              (onchip_memory1_s1_agent_m0_address),                    //  output,   width = 32,              m0.address
		.m0_burstcount           (onchip_memory1_s1_agent_m0_burstcount),                 //  output,    width = 3,                .burstcount
		.m0_byteenable           (onchip_memory1_s1_agent_m0_byteenable),                 //  output,    width = 4,                .byteenable
		.m0_debugaccess          (onchip_memory1_s1_agent_m0_debugaccess),                //  output,    width = 1,                .debugaccess
		.m0_lock                 (onchip_memory1_s1_agent_m0_lock),                       //  output,    width = 1,                .lock
		.m0_readdata             (onchip_memory1_s1_agent_m0_readdata),                   //   input,   width = 32,                .readdata
		.m0_readdatavalid        (onchip_memory1_s1_agent_m0_readdatavalid),              //   input,    width = 1,                .readdatavalid
		.m0_read                 (onchip_memory1_s1_agent_m0_read),                       //  output,    width = 1,                .read
		.m0_waitrequest          (onchip_memory1_s1_agent_m0_waitrequest),                //   input,    width = 1,                .waitrequest
		.m0_writedata            (onchip_memory1_s1_agent_m0_writedata),                  //  output,   width = 32,                .writedata
		.m0_write                (onchip_memory1_s1_agent_m0_write),                      //  output,    width = 1,                .write
		.rp_endofpacket          (onchip_memory1_s1_agent_rp_endofpacket),                //  output,    width = 1,              rp.endofpacket
		.rp_ready                (onchip_memory1_s1_agent_rp_ready),                      //   input,    width = 1,                .ready
		.rp_valid                (onchip_memory1_s1_agent_rp_valid),                      //  output,    width = 1,                .valid
		.rp_data                 (onchip_memory1_s1_agent_rp_data),                       //  output,  width = 128,                .data
		.rp_startofpacket        (onchip_memory1_s1_agent_rp_startofpacket),              //  output,    width = 1,                .startofpacket
		.cp_ready                (onchip_memory1_s1_burst_adapter_source0_ready),         //  output,    width = 1,              cp.ready
		.cp_valid                (onchip_memory1_s1_burst_adapter_source0_valid),         //   input,    width = 1,                .valid
		.cp_data                 (onchip_memory1_s1_burst_adapter_source0_data),          //   input,  width = 128,                .data
		.cp_startofpacket        (onchip_memory1_s1_burst_adapter_source0_startofpacket), //   input,    width = 1,                .startofpacket
		.cp_endofpacket          (onchip_memory1_s1_burst_adapter_source0_endofpacket),   //   input,    width = 1,                .endofpacket
		.cp_channel              (onchip_memory1_s1_burst_adapter_source0_channel),       //   input,    width = 4,                .channel
		.rf_sink_ready           (onchip_memory1_s1_agent_rsp_fifo_out_ready),            //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (onchip_memory1_s1_agent_rsp_fifo_out_valid),            //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (onchip_memory1_s1_agent_rsp_fifo_out_startofpacket),    //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (onchip_memory1_s1_agent_rsp_fifo_out_endofpacket),      //   input,    width = 1,                .endofpacket
		.rf_sink_data            (onchip_memory1_s1_agent_rsp_fifo_out_data),             //   input,  width = 129,                .data
		.rf_source_ready         (onchip_memory1_s1_agent_rf_source_ready),               //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (onchip_memory1_s1_agent_rf_source_valid),               //  output,    width = 1,                .valid
		.rf_source_startofpacket (onchip_memory1_s1_agent_rf_source_startofpacket),       //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (onchip_memory1_s1_agent_rf_source_endofpacket),         //  output,    width = 1,                .endofpacket
		.rf_source_data          (onchip_memory1_s1_agent_rf_source_data),                //  output,  width = 129,                .data
		.rdata_fifo_sink_ready   (onchip_memory1_s1_agent_rdata_fifo_out_ready),          //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (onchip_memory1_s1_agent_rdata_fifo_out_valid),          //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (onchip_memory1_s1_agent_rdata_fifo_out_data),           //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (onchip_memory1_s1_agent_rdata_fifo_src_ready),          //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (onchip_memory1_s1_agent_rdata_fifo_src_valid),          //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (onchip_memory1_s1_agent_rdata_fifo_src_data),           //  output,   width = 34,                .data
	...
	bram_altera_avalon_sc_fifo_191_e5eqkcq #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (0)
	) onchip_memory1_s1_agent_rsp_fifo (
		.clk               (clock_in_out_clk_clk),                               //   input,    width = 1,       clk.clk
		.reset             (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_memory1_s1_agent_rf_source_data),             //   input,  width = 129,        in.data
		.in_valid          (onchip_memory1_s1_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (onchip_memory1_s1_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (onchip_memory1_s1_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (onchip_memory1_s1_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (onchip_memory1_s1_agent_rsp_fifo_out_data),          //  output,  width = 129,       out.data
		.out_valid         (onchip_memory1_s1_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (onchip_memory1_s1_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (onchip_memory1_s1_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (onchip_memory1_s1_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
	...
	bram_altera_avalon_sc_fifo_191_e5eqkcq #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (0)
	) onchip_memory1_s1_agent_rdata_fifo (
		.clk               (clock_in_out_clk_clk),                             //   input,   width = 1,       clk.clk
		.reset             (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,   width = 1, clk_reset.reset
		.in_data           (onchip_memory1_s1_agent_rdata_fifo_src_data),      //   input,  width = 34,        in.data
		.in_valid          (onchip_memory1_s1_agent_rdata_fifo_src_valid),     //   input,   width = 1,          .valid
		.in_ready          (onchip_memory1_s1_agent_rdata_fifo_src_ready),     //  output,   width = 1,          .ready
		.out_data          (onchip_memory1_s1_agent_rdata_fifo_out_data),      //  output,  width = 34,       out.data
		.out_valid         (onchip_memory1_s1_agent_rdata_fifo_out_valid),     //  output,   width = 1,          .valid
		.out_ready         (onchip_memory1_s1_agent_rdata_fifo_out_ready),     //   input,   width = 1,          .ready
		.csr_address       (2'b00),                                            // (terminated),                        
		.csr_read          (1'b0),                                             // (terminated),                        
		.csr_write         (1'b0),                                             // (terminated),                        
		.csr_readdata      (),                                                 // (terminated),                        
	...
	bram_altera_merlin_router_191_nixttci router_004 (
		.sink_ready         (onchip_memory1_s1_agent_rp_ready),                 //  output,    width = 1,      sink.ready
		.sink_valid         (onchip_memory1_s1_agent_rp_valid),                 //   input,    width = 1,          .valid
		.sink_data          (onchip_memory1_s1_agent_rp_data),                  //   input,  width = 128,          .data
		.sink_startofpacket (onchip_memory1_s1_agent_rp_startofpacket),         //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (onchip_memory1_s1_agent_rp_endofpacket),           //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	bram_altera_merlin_burst_adapter_191_yuq35ea #(
		...
		.SYNC_RESET                (0)
	) onchip_memory1_s1_burst_adapter (
		...
		.source0_valid         (onchip_memory1_s1_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (onchip_memory1_s1_burst_adapter_source0_data),          //  output,  width = 128,          .data
		.source0_channel       (onchip_memory1_s1_burst_adapter_source0_channel),       //  output,    width = 4,          .channel
		.source0_startofpacket (onchip_memory1_s1_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (onchip_memory1_s1_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (onchip_memory1_s1_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
