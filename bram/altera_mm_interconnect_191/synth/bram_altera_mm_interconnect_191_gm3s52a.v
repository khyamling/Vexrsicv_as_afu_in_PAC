// bram_altera_mm_interconnect_191_gm3s52a.v
...
`timescale 1 ps / 1 ps
module bram_altera_mm_interconnect_191_gm3s52a (
	...
	wire  [129:0] rsp_mux_src_data;                                                   // rsp_mux:src_data -> VexRiscvAxi4_0_dBusaxi_agent:write_rp_data
	...
	wire  [129:0] rsp_mux_001_src_data;                                               // rsp_mux_001:src_data -> VexRiscvAxi4_0_dBusaxi_agent:read_rp_data
	...
	wire  [129:0] rsp_mux_002_src_data;                                               // rsp_mux_002:src_data -> VexRiscvAxi4_0_iBusaxi_agent:write_rp_data
	...
	wire  [129:0] rsp_mux_003_src_data;                                               // rsp_mux_003:src_data -> VexRiscvAxi4_0_iBusaxi_agent:read_rp_data
	...
	wire  [129:0] rsp_mux_004_src_data;                                               // rsp_mux_004:src_data -> master_0_master_agent:rp_data
	...
	wire  [130:0] onchip_memory_s1_agent_rf_source_data;                              // onchip_memory_s1_agent:rf_source_data -> onchip_memory_s1_agent_rsp_fifo:in_data
	...
	wire  [130:0] onchip_memory_s1_agent_rsp_fifo_out_data;                           // onchip_memory_s1_agent_rsp_fifo:out_data -> onchip_memory_s1_agent:rf_sink_data
	...
	wire  [129:0] vexriscvaxi4_0_dbusaxi_agent_write_cp_data;                         // VexRiscvAxi4_0_dBusaxi_agent:write_cp_data -> router:sink_data
	...
	wire  [129:0] vexriscvaxi4_0_dbusaxi_agent_read_cp_data;                          // VexRiscvAxi4_0_dBusaxi_agent:read_cp_data -> router_001:sink_data
	...
	wire  [129:0] vexriscvaxi4_0_ibusaxi_agent_write_cp_data;                         // VexRiscvAxi4_0_iBusaxi_agent:write_cp_data -> router_002:sink_data
	...
	wire  [129:0] vexriscvaxi4_0_ibusaxi_agent_read_cp_data;                          // VexRiscvAxi4_0_iBusaxi_agent:read_cp_data -> router_003:sink_data
	...
	wire  [129:0] master_0_master_agent_cp_data;                                      // master_0_master_agent:cp_data -> router_004:sink_data
	...
	wire  [129:0] onchip_memory_s1_agent_rp_data;                                     // onchip_memory_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [129:0] router_005_src_data;                                                // router_005:src_data -> rsp_demux:sink_data
	...
	wire  [129:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> onchip_memory_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                  // onchip_memory_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [4:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> onchip_memory_s1_burst_adapter:sink0_channel
	...
	wire  [129:0] onchip_memory_s1_burst_adapter_source0_data;                        // onchip_memory_s1_burst_adapter:source0_data -> onchip_memory_s1_agent:cp_data
	...
	wire  [129:0] cmd_demux_003_src0_data;                                            // cmd_demux_003:src0_data -> cmd_mux:sink3_data
	...
	wire  [129:0] cmd_demux_004_src0_data;                                            // cmd_demux_004:src0_data -> cmd_mux:sink4_data
	...
	wire  [129:0] rsp_demux_src3_data;                                                // rsp_demux:src3_data -> rsp_mux_003:sink0_data
	...
	wire  [129:0] rsp_demux_src4_data;                                                // rsp_demux:src4_data -> rsp_mux_004:sink0_data
	...
	bram_altera_merlin_axi_master_ni_191_vbkraky #(
		...
		.write_cp_data          (vexriscvaxi4_0_dbusaxi_agent_write_cp_data),          //  output,  width = 130,                 .data
		...
		.read_cp_data           (vexriscvaxi4_0_dbusaxi_agent_read_cp_data),           //  output,  width = 130,                 .data
	...
	bram_altera_merlin_axi_master_ni_191_vbkraky #(
		...
		.write_cp_data          (vexriscvaxi4_0_ibusaxi_agent_write_cp_data),          //  output,  width = 130,                 .data
		...
		.write_rp_data          (rsp_mux_002_src_data),                                //   input,  width = 130,                 .data
		...
		.read_cp_data           (vexriscvaxi4_0_ibusaxi_agent_read_cp_data),           //  output,  width = 130,                 .data
		...
		.read_rp_data           (rsp_mux_003_src_data),                                //   input,  width = 130,                 .data
	...
	bram_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.rp_data               (rsp_mux_004_src_data),                                               //   input,  width = 130,          .data
	...
	bram_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (onchip_memory_s1_agent_rp_data),                       //  output,  width = 130,                .data
		...
		.cp_data                 (onchip_memory_s1_burst_adapter_source0_data),          //   input,  width = 130,                .data
		...
		.rf_sink_data            (onchip_memory_s1_agent_rsp_fifo_out_data),             //   input,  width = 131,                .data
		...
		.rf_source_data          (onchip_memory_s1_agent_rf_source_data),                //  output,  width = 131,                .data
	...
	bram_altera_avalon_sc_fifo_191_e5eqkcq #(
		...
		.clk               (clock_in_out_clk_clk),                              //   input,    width = 1,       clk.clk
		.reset             (onchip_memory_reset1_reset_bridge_in_reset_reset),  //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_memory_s1_agent_rf_source_data),             //   input,  width = 131,        in.data
		...
		.out_data          (onchip_memory_s1_agent_rsp_fifo_out_data),          //  output,  width = 131,       out.data
	...
	bram_altera_merlin_router_191_ozwfnza router (
		...
		.sink_data          (vexriscvaxi4_0_dbusaxi_agent_write_cp_data),          //   input,  width = 130,          .data
	...
	bram_altera_merlin_router_191_ozwfnza router_001 (
		...
		.sink_data          (vexriscvaxi4_0_dbusaxi_agent_read_cp_data),          //   input,  width = 130,          .data
	...
	bram_altera_merlin_router_191_ozwfnza router_002 (
		...
		.sink_data          (vexriscvaxi4_0_ibusaxi_agent_write_cp_data),          //   input,  width = 130,          .data
	...
	bram_altera_merlin_router_191_ozwfnza router_003 (
		...
		.sink_data          (vexriscvaxi4_0_ibusaxi_agent_read_cp_data),          //   input,  width = 130,          .data
	...
	bram_altera_merlin_router_191_ozwfnza router_004 (
	...
	bram_altera_merlin_router_191_ob7ymby router_005 (
		...
		.sink_data          (onchip_memory_s1_agent_rp_data),                   //   input,  width = 130,          .data
	...
	bram_altera_merlin_burst_adapter_191_2h5uf5i #(
		.PKT_ADDR_H                (67),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (99),
		.PKT_BYTE_CNT_H            (84),
		...
		.reset                 (onchip_memory_reset1_reset_bridge_in_reset_reset),     //   input,    width = 1, cr0_reset.reset
		...
		.source0_data          (onchip_memory_s1_burst_adapter_source0_data),          //  output,  width = 130,          .data
	...
	bram_altera_merlin_demultiplexer_191_ply4cda cmd_demux (
		.clk                (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	bram_altera_merlin_demultiplexer_191_ply4cda cmd_demux_001 (
		.clk                (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	bram_altera_merlin_demultiplexer_191_ply4cda cmd_demux_002 (
		.clk                (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	bram_altera_merlin_demultiplexer_191_ply4cda cmd_demux_003 (
		.clk                (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	bram_altera_merlin_demultiplexer_191_ply4cda cmd_demux_004 (
		.clk                (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src0_data          (cmd_demux_004_src0_data),                          //  output,  width = 130,          .data
	...
	bram_altera_merlin_multiplexer_191_bvvxa3q cmd_mux (
		.clk                 (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (onchip_memory_reset1_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink4_data          (cmd_demux_004_src0_data),                          //   input,  width = 130,          .data
	...
	bram_altera_merlin_demultiplexer_191_myfhcmi rsp_demux (
		.clk                (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (onchip_memory_reset1_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src2_data          (rsp_demux_src2_data),                              //  output,  width = 130,          .data
		...
		.src3_data          (rsp_demux_src3_data),                              //  output,  width = 130,          .data
		...
		.src4_data          (rsp_demux_src4_data),                              //  output,  width = 130,          .data
	...
	bram_altera_merlin_multiplexer_191_ccgdhaq rsp_mux (
		.clk                 (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	bram_altera_merlin_multiplexer_191_ccgdhaq rsp_mux_001 (
		.clk                 (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	bram_altera_merlin_multiplexer_191_ccgdhaq rsp_mux_002 (
		.clk                 (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (rsp_demux_src2_data),                              //   input,  width = 130,          .data
	...
	bram_altera_merlin_multiplexer_191_ccgdhaq rsp_mux_003 (
		.clk                 (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (rsp_demux_src3_data),                              //   input,  width = 130,          .data
	...
	bram_altera_merlin_multiplexer_191_ccgdhaq rsp_mux_004 (
		...
		.sink0_data          (rsp_demux_src4_data),                              //   input,  width = 130,          .data
