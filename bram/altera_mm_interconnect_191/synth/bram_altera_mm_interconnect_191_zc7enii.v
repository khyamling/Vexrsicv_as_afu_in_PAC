// bram_altera_mm_interconnect_191_zc7enii.v
...
`timescale 1 ps / 1 ps
module bram_altera_mm_interconnect_191_zc7enii (
	...
	wire  [128:0] rsp_mux_src_data;                                     // rsp_mux:src_data -> VexRiscvAxi4_0_dBusaxi_agent:write_rp_data
	...
	wire  [128:0] rsp_mux_001_src_data;                                 // rsp_mux_001:src_data -> VexRiscvAxi4_0_dBusaxi_agent:read_rp_data
	...
	wire  [128:0] rsp_mux_002_src_data;                                 // rsp_mux_002:src_data -> VexRiscvAxi4_0_iBusaxi_agent:write_rp_data
	...
	wire  [128:0] rsp_mux_003_src_data;                                 // rsp_mux_003:src_data -> VexRiscvAxi4_0_iBusaxi_agent:read_rp_data
	...
	wire  [165:0] onchip_memory_s1_agent_rf_source_data;                // onchip_memory_s1_agent:rf_source_data -> onchip_memory_s1_agent_rsp_fifo:in_data
	...
	wire  [165:0] onchip_memory_s1_agent_rsp_fifo_out_data;             // onchip_memory_s1_agent_rsp_fifo:out_data -> onchip_memory_s1_agent:rf_sink_data
	...
	wire  [128:0] vexriscvaxi4_0_dbusaxi_agent_write_cp_data;           // VexRiscvAxi4_0_dBusaxi_agent:write_cp_data -> router:sink_data
	...
	wire  [128:0] vexriscvaxi4_0_dbusaxi_agent_read_cp_data;            // VexRiscvAxi4_0_dBusaxi_agent:read_cp_data -> router_001:sink_data
	...
	wire  [128:0] router_001_src_data;                                  // router_001:src_data -> cmd_demux_001:sink_data
	...
	wire  [128:0] vexriscvaxi4_0_ibusaxi_agent_write_cp_data;           // VexRiscvAxi4_0_iBusaxi_agent:write_cp_data -> router_002:sink_data
	...
	wire  [128:0] vexriscvaxi4_0_ibusaxi_agent_read_cp_data;            // VexRiscvAxi4_0_iBusaxi_agent:read_cp_data -> router_003:sink_data
	...
	wire  [164:0] onchip_memory_s1_agent_rp_data;                       // onchip_memory_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [164:0] onchip_memory_s1_burst_adapter_source0_data;          // onchip_memory_s1_burst_adapter:source0_data -> onchip_memory_s1_agent:cp_data
	...
	wire  [164:0] router_004_src_data;                                  // router_004:src_data -> onchip_memory_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                 // onchip_memory_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [3:0] router_004_src_channel;                               // router_004:src_channel -> onchip_memory_s1_rsp_width_adapter:in_channel
	...
	wire  [128:0] onchip_memory_s1_rsp_width_adapter_src_data;          // onchip_memory_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          onchip_memory_s1_rsp_width_adapter_src_ready;         // rsp_demux:sink_ready -> onchip_memory_s1_rsp_width_adapter:out_ready
	wire    [3:0] onchip_memory_s1_rsp_width_adapter_src_channel;       // onchip_memory_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [128:0] cmd_mux_src_data;                                     // cmd_mux:src_data -> onchip_memory_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                    // onchip_memory_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                  // cmd_mux:src_channel -> onchip_memory_s1_cmd_width_adapter:in_channel
	...
	wire  [164:0] onchip_memory_s1_cmd_width_adapter_src_data;          // onchip_memory_s1_cmd_width_adapter:out_data -> onchip_memory_s1_burst_adapter:sink0_data
	...
	bram_altera_merlin_axi_master_ni_191_vbkraky #(
		...
		.write_cp_data          (vexriscvaxi4_0_dbusaxi_agent_write_cp_data),          //  output,  width = 129,                 .data
		...
		.write_rp_data          (rsp_mux_src_data),                                    //   input,  width = 129,                 .data
		...
		.read_cp_data           (vexriscvaxi4_0_dbusaxi_agent_read_cp_data),           //  output,  width = 129,                 .data
		...
		.read_rp_data           (rsp_mux_001_src_data),                                //   input,  width = 129,                 .data
	...
	bram_altera_merlin_axi_master_ni_191_vbkraky #(
		...
		.write_cp_data          (vexriscvaxi4_0_ibusaxi_agent_write_cp_data),          //  output,  width = 129,                 .data
		...
		.write_rp_data          (rsp_mux_002_src_data),                                //   input,  width = 129,                 .data
		...
		.read_cp_data           (vexriscvaxi4_0_ibusaxi_agent_read_cp_data),           //  output,  width = 129,                 .data
		...
		.read_rp_data           (rsp_mux_003_src_data),                                //   input,  width = 129,                 .data
	...
	bram_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (onchip_memory_s1_agent_rp_data),                       //  output,  width = 165,                .data
		...
		.cp_data                 (onchip_memory_s1_burst_adapter_source0_data),          //   input,  width = 165,                .data
		...
		.rf_sink_data            (onchip_memory_s1_agent_rsp_fifo_out_data),             //   input,  width = 166,                .data
		...
		.rf_source_data          (onchip_memory_s1_agent_rf_source_data),                //  output,  width = 166,                .data
	...
	bram_altera_avalon_sc_fifo_191_e5eqkcq #(
		...
		.clk               (clock_in_out_clk_clk),                              //   input,    width = 1,       clk.clk
		.reset             (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset),  //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_memory_s1_agent_rf_source_data),             //   input,  width = 166,        in.data
		...
		.out_data          (onchip_memory_s1_agent_rsp_fifo_out_data),          //  output,  width = 166,       out.data
	...
	bram_altera_merlin_router_191_nacnfia router (
		...
		.sink_data          (vexriscvaxi4_0_dbusaxi_agent_write_cp_data),          //   input,  width = 129,          .data
	...
	bram_altera_merlin_router_191_nacnfia router_001 (
		...
		.sink_data          (vexriscvaxi4_0_dbusaxi_agent_read_cp_data),          //   input,  width = 129,          .data
	...
	bram_altera_merlin_router_191_nacnfia router_002 (
		...
		.sink_data          (vexriscvaxi4_0_ibusaxi_agent_write_cp_data),          //   input,  width = 129,          .data
	...
	bram_altera_merlin_router_191_nacnfia router_003 (
		...
		.sink_data          (vexriscvaxi4_0_ibusaxi_agent_read_cp_data),          //   input,  width = 129,          .data
	...
	bram_altera_merlin_router_191_64cblii router_004 (
		...
		.sink_data          (onchip_memory_s1_agent_rp_data),                   //   input,  width = 165,          .data
	...
	bram_altera_merlin_burst_adapter_191_esbk5oy #(
		.PKT_ADDR_H                (103),
		.PKT_ADDR_L                (72),
		.PKT_BEGIN_BURST           (136),
		.PKT_BYTE_CNT_H            (121),
		...
		.sink0_data            (onchip_memory_s1_cmd_width_adapter_src_data),          //   input,  width = 165,          .data
		.sink0_channel         (onchip_memory_s1_cmd_width_adapter_src_channel),       //   input,    width = 4,          .channel
		...
		.source0_data          (onchip_memory_s1_burst_adapter_source0_data),          //  output,  width = 165,          .data
	...
	bram_altera_merlin_demultiplexer_191_xztrwva cmd_demux_001 (
		.clk                (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src0_data          (cmd_demux_001_src0_data),                          //  output,  width = 129,          .data
	...
	bram_altera_merlin_demultiplexer_191_xztrwva cmd_demux_002 (
		.clk                (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src0_data          (cmd_demux_002_src0_data),                          //  output,  width = 129,          .data
	...
	bram_altera_merlin_demultiplexer_191_xztrwva cmd_demux_003 (
		.clk                (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src0_data          (cmd_demux_003_src0_data),                          //  output,  width = 129,          .data
	...
	bram_altera_merlin_multiplexer_191_g4wmb6i cmd_mux (
		.clk                 (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_data          (cmd_demux_001_src0_data),                          //   input,  width = 129,          .data
		...
		.sink2_data          (cmd_demux_002_src0_data),                          //   input,  width = 129,          .data
		...
		.sink3_data          (cmd_demux_003_src0_data),                          //   input,  width = 129,          .data
	...
	bram_altera_merlin_demultiplexer_191_7csmkni rsp_demux (
		.clk                (clock_in_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset              (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset),     //   input,    width = 1, clk_reset.reset
		.sink_ready         (onchip_memory_s1_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (onchip_memory_s1_rsp_width_adapter_src_channel),       //   input,    width = 4,          .channel
		.sink_data          (onchip_memory_s1_rsp_width_adapter_src_data),          //   input,  width = 129,          .data
		...
		.src1_data          (rsp_demux_src1_data),                                  //  output,  width = 129,          .data
		...
		.src2_data          (rsp_demux_src2_data),                                  //  output,  width = 129,          .data
		...
		.src3_data          (rsp_demux_src3_data),                                  //  output,  width = 129,          .data
	...
	bram_altera_merlin_multiplexer_191_ec4vqtq rsp_mux (
		.clk                 (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (VexRiscvAxi4_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	bram_altera_merlin_multiplexer_191_ec4vqtq rsp_mux_001 (
		...
		.sink0_data          (rsp_demux_src1_data),                              //   input,  width = 129,          .data
	...
	bram_altera_merlin_multiplexer_191_ec4vqtq rsp_mux_002 (
		...
		.sink0_data          (rsp_demux_src2_data),                              //   input,  width = 129,          .data
	...
	bram_altera_merlin_multiplexer_191_ec4vqtq rsp_mux_003 (
		...
		.sink0_data          (rsp_demux_src3_data),                              //   input,  width = 129,          .data
	...
	bram_altera_merlin_width_adapter_191_v2tkzla #(
		.IN_PKT_ADDR_H                 (103),
		.IN_PKT_ADDR_L                 (72),
		.IN_PKT_DATA_H                 (63),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (router_004_src_data),                                  //   input,  width = 165,          .data
		.out_endofpacket      (onchip_memory_s1_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (onchip_memory_s1_rsp_width_adapter_src_data),          //  output,  width = 129,          .data
		.out_channel          (onchip_memory_s1_rsp_width_adapter_src_channel),       //  output,    width = 4,          .channel
	...
	bram_altera_merlin_width_adapter_191_6aytl5i #(
		.IN_PKT_ADDR_H                 (67),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (cmd_mux_src_data),                                     //   input,  width = 129,          .data
		.out_endofpacket      (onchip_memory_s1_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (onchip_memory_s1_cmd_width_adapter_src_data),          //  output,  width = 165,          .data
		.out_channel          (onchip_memory_s1_cmd_width_adapter_src_channel),       //  output,    width = 4,          .channel
